...
ADD engine-recomendacion-maki.zip  ${PIO_HOME}/engines

RUN cd ${PIO_HOME}/engines \
    && unzip engine-recomendacion-maki.zip \
    && rm engine-recomendacion-maki.zip

WORKDIR ${PIO_HOME}/engines/engine-recomendacion-maki
